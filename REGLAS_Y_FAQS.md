# 🔮 Compendio de Reglas, Aclaraciones Oficiales y FAQs - Heroes III: El Juego de Mesa
...
## 📋 Índice Temático
1. [🏰 Correcciones de Terminología y Erratas Oficiales](#1-correcciones-de-terminología-y-erratas-oficiales)
2. [👣 Exploración, Mapa de Aventura y Movimiento](#2-exploración-mapa-de-aventura-y-movimiento)
3. [⚔️ Combate Táctico, Iniciativa y Contraataques](#3-combate-táctico-iniciativa-y-contraataques)
4. [🔥 Magia de Héroe, Hechizos y Escuelas Elementales](#4-magia-de-héroe-hechizos-y-escuelas-elementales)
5. [💎 Colección de Artefactos, Reliquias y Pergaminos](#5-colección-de-artefactos-reliquias-y-pergaminos)
...
## 1. 🏰 Correcciones de Terminología y Erratas Oficiales

Para evitar fallos en las búsquedas del sistema y asegurar el total cumplimiento con las cartas físicas, se establecen las traducciones y reglas ortográficas exactas:

### 🐉 Tabla de Denominación de Criaturas y Facciones Oficiales

| Término Original (EN) | Traducción Oficial (ES) | Facción | Regla Crítica de Ortografía |
| :--- | :--- | :--- | :--- |
| **Castle** | 🏰 **Castillo** | Castillo | Nombre oficial de facción. |
| **Necropolis** | 💀 **Necrópolis** | Necrópolis | Nombre oficial de facción. |
...
| **Pegasi** | 🦄 **Pegasos** | Murallas | Rango Plata. |
| **Dendroids** | 🌳 **Dendroides** | Murallas | Rango Plata. |
| **Unicorns** | 🦄 **Unicornios** | Murallas | Rango Oro. |
| **Gold Dragons** | 🐲 **Dragones dorados** | Murallas | Rango Oro. En minúscula la "d" de dorados. |

### 🔒 Regla General de Cartas de Habilidad Permanente
> ⚠️ **Regla del Candado:** Una carta con el símbolo de un candado (**Permanente**) permanece activa sobre la mesa aportando sus beneficios pasivos. Sin embargo, cada héroe cuenta con un número limitado de "ranuras místicas". Si el jugador decide activar otra habilidad permanente o artefacto que compita por la misma ranura, la carta permanente previa es descartada y enviada a la **pila de descartes**.

---

## 2. 👣 Exploración, Mapa de Aventura y Movimiento

> ### ❓ P: ¿Cómo se calculan de forma exacta los Puntos de Movimiento (PM) al iniciar el turno?
> * **Respuesta:** Tu héroe recibe una base de **3 PM** de forma predeterminada al comenzar la ronda. Esta base se modifica de la siguiente forma:
>   1. 🏛️ **Establos (Stables):** Si tu héroe inicia su turno en una ciudad con *Establos* construidos, o si visitó la loseta de *Establos* en el mapa de aventura durante la ronda anterior, gana **+1 PM** adicional para todo el turno.
>   2. 📜 **Habilidad de Logística:** Jugar el nivel *Experto* de la habilidad secundaria de **Logística** te concede un aumento inmediato de **+1 PM** para ese turno. El nivel *Básico* te permite moverte de forma gratuita un hexágono al final del turno.
>   3. ❄️ **Penalizaciones por Terreno:** Las casillas de pantano, nieve profunda o barro denso consumen **2 PM** por hexágono en lugar de 1 PM, a menos que poseas la habilidad experta de **Buscador de Caminos** o uses hechizos utilitarios como *Volar* o *Caminar sobre el Agua*.

> ### ❓ P: ¿Pueden dos héroes míos ocupar el mismo hexágono del mapa?
> * **Respuesta:** **No.** El reglamento prohíbe terminantemente que dos figuras de héroe compartan el mismo hexágono o casilla de mapa de aventura al final de un movimiento. No obstante, puedes cruzar libremente a través de las casillas ocupadas por tus propios héroes durante tu fase de movimiento, siempre que finalices tu trayecto en una casilla totalmente vacía.

> ### ❓ P: ¿Cómo funciona exactamente el descubrimiento y excavación del Grial?
> * **Respuesta:** El Grial (borde verde esmeralda) es el elemento místico más poderoso del mapa de aventura. Su excavación se resuelve de la siguiente forma:
...
## 3. ⚔️ Combate Táctico, Iniciativa y Contraataques

> ### ❓ P: Si dos unidades empatan en su valor de Iniciativa (⚡), ¿cuál actúa primero?
> * **Respuesta:** En caso de empate numérico exacto en la iniciativa, **el empate se resuelve siempre a favor del Defensor**. La unidad defensora se activará primero en el track de iniciativa en esa ronda de combate táctico.

> ### ❓ P: ¿La defensa (🛡️) mitiga el daño en cada ataque que se reciba?
> * **Respuesta:** **Sí.** El valor de defensa de la criatura resta heridas directas en **cada ataque individual** recibido en la misma ronda de combate. Si tu unidad sufre tres ataques cuerpo a cuerpo seguidos por enemigos diferentes en el mismo turno, su defensa se aplica las tres veces de forma independiente para mitigar el daño de cada ataque.

> ### ❓ P: ¿Cuándo y cuántas veces se puede realizar un ataque de represalia?
> * **Respuesta:** Cualquier unidad que sobreviva a un ataque físico cuerpo a cuerpo (melé) y no haya contraatacado en la ronda de combate actual **debe realizar un ataque de represalia inmediato** contra su atacante.
>   * Cada unidad puede contraatacar **exactamente una vez por ronda**. Tras hacerlo, se le coloca un cubo negro de control para indicarlo.
>   * ❌ **Sin Represalia:** Las unidades atacadas por criaturas con la habilidad especial de *Sin Represalia* (ej. Arpías de élite o Vampiros básicos) no pueden contraatacar.
>   * 🏹 **A Distancia:** Los ataques con proyectiles de tiradores nunca desencadenan represalias físicas.
>   * 🦅 **Grifos:** Los Grifos y Grifos Reales ignoran el límite habitual y pueden contraatacar de forma ilimitada a todas las agresiones físicas que reciban.

> ### ❓ P: ¿Qué penalizaciones sufren las unidades a distancia en combate cuerpo a cuerpo?
> * **Respuesta:** Si un tirador tiene a una unidad enemiga adyacente en el tablero táctico:
...
>   * *Excepción:* Las unidades de rango Élite con la habilidad pasiva *Sin penalización en cuerpo a cuerpo* (ej. Fanáticos de élite u Ojos Maléficos mejorados) ignoran esta reducción y golpean con todo su poder.

---

## 4. 🔥 Magia de Héroe, Hechizos y Escuelas Elementales

> ### ❓ P: ¿Cuál es el límite real de cartas de hechizo que puedo mantener en mi mano?
> * **Respuesta:** Viene determinado estrictamente por la estadística de **Conocimiento** de tu héroe. Si tu héroe posee 2 de Conocimiento, al reponer cartas durante la Fase de Planificación, no podrás retener más de 2 cartas de hechizo en tu mano activa.

> ### ❓ P: ¿Cómo funciona el hechizo Flecha Mágica (Magic Arrow) contra inmunidades elementales?
> * **Respuesta:** La *Flecha Mágica* es un hechizo neutro y místico:
>   * Se beneficia del incremento de daño de **cualquier escuela elemental** que domines (Aire, Tierra, Fuego o Agua).
>   * **Regla de Inmunidad:** Al ser un hechizo neutro sin afinidad pura a un elemento, **ninguna criatura con inmunidad elemental puede ignorar su daño**. Por ejemplo, un Gólem de Acero (inmune al Fuego) recibirá el daño completo de una Flecha Mágica potenciada con poder de Fuego.

> ### ❓ P: ¿Puedo lanzar el hechizo Resurrección (Resurrection) para recuperar unidades muertas por magia o la Torre de Flechas?
> * **Respuesta:** **No.** El hechizo de *Resurrección* (escuela de Tierra) tiene una limitación estricta de FAQs oficiales: **solo se puede lanzar para mitigar y sanar el daño infligido por ataques físicos directos de criaturas enemigas**.
>   * Si tu unidad es eliminada por un hechizo de daño directo (ej. *Rayo* o *Implosión*), efectos pasivos (ej. *Nube de Muerte*) o la Torre de Flechas en un asedio, **no puede ser resucitada**.
...
> ### ❓ P: ¿La limpieza del hechizo Curar (Cure) me obliga a purgar mis propios bufos beneficiosos?
> * **Respuesta:** **No.** En el juego de mesa, limpiar efectos dañinos con el hechizo *Curar* (escuela de Agua) es **totalmente opcional**. Puedes sanar el daño físico y optar por remover una maldición de fuego enemiga, manteniendo intactos tus bufos de *Celeridad* o *Bendición* activos.

> ### ❓ P: ¿Por qué exige el hechizo Implosión (Implosion) descartar cartas para poder jugarse?
> * **Respuesta:** El hechizo *Implosión* requiere un nivel mínimo de **Poder 1** para activarse. Dado que la mayoría de héroes inician su andadura con Poder 0 en sus estadísticas básicas, **el jugador está obligado a realizar la acción de Potenciar (Empower), descartando 1 carta de su mano de juego para sumar +1 de Poder** y poder conjurarlo.

> ### ❓ P: ¿Cómo interactúa el hechizo Bendecir (Bless) con las tiradas del dado de ataque?
> * **Respuesta:** *Bendecir* obliga a tu criatura a ignorar la tirada física del dado rojo, aplicando automáticamente el daño máximo listado en su ficha.
>   * **Consecuencia de FAQs:** Dado que no se realiza tirada física, **no se genera ningún resultado del dado**. Cualquier habilidad pasiva o activa de una unidad que dependa de caras específicas del dado de ataque **no puede activarse**. Por ejemplo: los Zombis enemigos no ganan su bono de defensa al salir un `+1`, ni las Momias aplican maldiciones.

---

## 5. 💎 Colección de Artefactos, Reliquias y Pergaminos

> ### ❓ P: Al obtener un Artefacto explorando el mapa, ¿se envía a mi pila de descartes?
> * **Respuesta:** **No.** Existe la **Regla Sagrada de Adquisición** para cartas de Artefacto (Menores, Mayores o Reliquias): **se añaden DIRECTAMENTE A TU MANO de juego activa**, permitiendo jugarlos inmediatamente en el mismo turno si cumples los requisitos. Una vez jugados y resueltos, se envían a tu pila de descartes del héroe.
...
> ### ❓ P: ¿Cómo funcionan los Pergaminos de Hechizo (Scrolls) en la expansión de Bastión?
...
>   * 🛡️ **Poder Reducido:** Los hechizos de pergaminos se lanzan siempre en su **línea de poder más débil (Poder 0)**. No se pueden potenciar descartando cartas ni sumar bonus de escuelas mágicas.
>   * 🚫 **Límite de Control:** Un héroe puede controlar un máximo de **2 pergaminos activos simultáneamente**. Si adquiere un tercero, debe descartar uno de los activos.
>   * 🪙 **Venta:** Puedes vender pergaminos en cualquier Mercadillo recibiendo **2 de Oro** por cada hechizo que aún permanezca sin usar sobre la carta.
...
> * **Respuesta:** Al subir de nivel en tu pista de Experiencia, tu héroe incrementa pasivamente su límite de cartas en mano al reponer (indicado en el track de nivel). Esto te permite mantener más cartas tácticas, estadísticas y artefactos listos para su uso durante la Fase de Planificación de cada ronda.

> ### ❓ P: ¿Se puede usar la habilidad de Artillería con cualquier máquina de guerra?
> * **Respuesta:** **No.** La habilidad de **Artillería** afecta de forma muy selectiva: su nivel básico inflige 1 herida directa a la unidad enemiga de menor iniciativa en el tablero, y su nivel experto potencia **única y exclusivamente los disparos de la Balista** (permitiendo resolver su disparo 3 veces consecutivas al mismo objetivo). No otorga ninguna bonificación a la Catapulta ni al Carro de Municiones.

---

## 7. 🏘️ Desarrollo Urbano, Edificios y Reclutamiento

> ### ❓ P: ¿Puedo construir múltiples edificios en el mismo turno si dispongo de recursos suficientes?
> * **Respuesta:** **No.** El reglamento limita estrictamente el desarrollo urbano a **exactamente una estructura construida por ronda** durante tu Fase de Planificación, pagando los costes correspondientes en Oro (🪙), Madera (🪵), Mineral (🪨) o Valiosos (🔮) en tu track de recursos.

> ### ❓ P: ¿Cómo se calcula el coste de refuerzo y la mejora de unidades a rango Élite?
> * **Respuesta:** Las cartas de unidad son de doble cara (cara Básica y cara de Élite mejorada):
>   * 🔄 **Promoción/Refuerzo:** Si tienes una unidad básica en tu ejército activo y quieres mejorarla, debes visitar tu Metrópolis natal y pagar la **diferencia exacta en recursos** (Oro, etc.) entre ambas caras. Acto seguido, volteas la carta a su lado de Élite.
>   * 🛡️ **Reclutamiento de Élite Directo:** Si ya has construido el Castillo y las viviendas mejoradas del regimiento, puedes alistar directamente la unidad en su versión de Élite pagando su coste total de Élite.

> ### ❓ P: ¿Cómo recupero mis unidades caídas en combate?
> * **Respuesta:** Las unidades derrotadas van a tu pila de bajas personal. Durante tu Fase de Planificación, puedes realizar la acción de **Reclutar** en tu ciudad, pagando el coste total de Oro de las unidades disponibles en tus viviendas construidas para devolverlas a tu ejército activo.

---

## 8. 🗺️ Modos de Juego, Alianzas, Cooperativo y Eliminación
...
### 💀 Reglas Oficiales de Eliminación de la Partida

Existen dos vías reglamentarias oficiales para sufrir la **eliminación directa e irreversible** de la partida:

1. 🏚️ **Sin Base Operativa:** Pasar **3 rondas completas de juego** consecutivas sin controlar al menos una ciudad o un asentamiento en el mapa de aventura.
2. ⚔️ **Derrota del Héroe Principal sin Base:** Perder un combate con tu *Héroe Principal* cuando no te quede bajo control ninguna ciudad o asentamiento en el mapa (esto incluye perder a tu héroe defendiendo tu última fortaleza de un asedio).
...
* 👹 **Participación Activa:** El jugador eliminado no queda inactivo. Asume el **control directo de las Unidades Neutrales de la IA** en todos los combates que libren los jugadores supervivientes, intentando derrotarlos en la mesa táctica.
...
2. 🔎 **Contexto Dinámico bajo Demanda (`src/data/knowledgeIndex.ts`):** Para evitar saturar el límite de tokens y optimizar costos de procesamiento con los datos masivos de los **64 héroes**, **~156 unidades**, **32 habilidades secundarias** y **10 ciudades**:
   * Se envía siempre un **catálogo de índice compacto** que actúa como mapa mental para que Sandro conozca qué elementos oficiales existen en el juego de mesa.
   * La aplicación analiza en tiempo real el texto del chat. Si detecta nombres específicos (como *"Septienna"*, *"Gólems de acero"* o *"Tesoros Elfos"*), **el sistema extrae automáticamente la ficha técnica detallada completa** de la base de datos de la UI y la inyecta de forma dinámica en el contexto de Sandro.
   * Gracias a esta arquitectura modular, Sandro puede leer al instante estadísticas de vida, ataque, defensa y habilidades pasivas de la criatura o héroe por el que preguntas, garantizando resoluciones 100% fieles al reglamento oficial.

---

*Compilado, corregido y validado bajo la atenta mirada de Sandro, en las oscuras e inexpugnables torres arcanas de Deyja.* 💀🔮
