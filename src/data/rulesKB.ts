...
El juego cuenta con un total de 10 facciones oficiales que comprenden el juego base y todas las expansiones:
...
10. Cala (Borde Turquesa): Piratas, corsarios y serpientes marinas del océano. Facilidad absoluta para la navegación costera, astilleros ágiles y contrabando de recursos.`
  ...
  {
    id: "components_dice_tokens",
    title: "2. Componentes, Dados y Fichas Especiales de Juego",
    category: "components",
...
El juego incorpora tres tipos de dados de seis caras (d6) especiales reglamentarios para definir la fortuna, las tácticas y las recompensas (no existen dados de asedio específicos en el juego de mesa, todos los asaltos y catapultas se resuelven empleando el dado de combate estándar):
...
Para regular diversos efectos atmosféricos, tácticos y limitaciones, el juego de mesa utiliza fichas dedicadas:
...
7. Fichas de Minas Terrestres (Land Mine Spell Tokens): Fichas colocadas en el tablero de batalla por el hechizo de fuego "Mina Terrestre". Actúan como trampas explosivas pasivas. La primera unidad de combate que cruce o se posicione encima de una casilla minada detiene su movimiento de forma instantánea, detona el marcador y sufre d3 a d6 heridas de daño de fuego directo (según el nivel de poder del héroe), tras lo cual se remueve la mina de la reja.`
  ...
  {
    id: "cards_types",
    title: "3. Tipos de Cartas",
    category: "components",
    content: `El juego procesa múltiples tipos de cartas con funciones operativas rígidas sobre el mantel:
1. Cartas de Hechizo: Se adquieren principalmente en la Cofradía de Magos o en Santuarios. Se dividen en Hechizos de Combate y Hechizos de Mapa de Aventura.
2. Cartas de Artefacto: Se clasifican en Menores, Mayores y Reliquias. Siempre que se obtienen, van DIRECTAMENTE A LA MANO (no al mazo).
3. Cartas de Especialidad: Únicas e intransferibles de cada Héroe. Se obtienen automáticamente al alcanzar el rango Dorado (niveles IV y VI).
4. Cartas de Habilidad: Representan la progresión del Héroe. Al subir de nivel a un rango Plata (II, III, V, VII), se draftea de un mazo común. Poseen un efecto Básico (gratis) y un efecto Experto (requiere gastar un contador de Experto).
5. Cartas de Característica: Representan el Poder (potencia de hechizo), Conocimiento, Ataque y Defensa del héroe. Forman el esqueleto del mazo de Fuerza y Magia para potenciar acciones.
6. Cartas de Unidad / Criatura: Cada facción cuenta con sus unidades de combate de rango Bronce, Plata y Oro. Tienen doble cara ("Unas pocas" y "Manada"). Indican Ataque, Defensa, Puntos de Salud, Iniciativa y Habilidades Especiales pasivas/activas de la unidad. Se colocan delante del jugador y se despliegan en el tablero de combate.
7. Cartas de Ciudad: Tarjetas de referencia y control de tu Ciudad.
8. Cartas de Caja de Pandora: Representan encuentros especiales de gran peligro y altísima recompensa. Al interactuar con el hexágono de la Caja de Pandora en el mapa, se roba esta carta que detona una batalla de emboscada inmediata contra regimientos neutrales potenciados. La recompensa por la supervivencia del héroe incluye inmensas fortunas de Oro, maestrías gratuitas, reliquias míticas o el aprendizaje instantáneo de hechizos de nivel experto.`
  },
  {
    id: "grail_and_artifacts",
    title: "4. Tipos de Artefactos y el Grial de Erathia",
    category: "components",
...
Esta sección detalla de forma exhaustiva las reglas oficiales del juego de mesa para el uso de las cartas de Artefacto (Menores, Mayores, Reliquias, Grial y Pergaminos) en Heroes of Might and Magic III: El Juego de Mesa.
...
• Altar de Conflujo: Permite sacrificar artefactos menores que tengas en tu mano activa para transmutarlos en Puntos de Experiencia (Exp) directa o valiosos Objetos de Valor.`
  },
  {
    ...
    title: "5. Preparación de las Partidas y Selección de Dificultad",
    category: "setup",
...
Nota sobre Campañas: Las misiones de campaña tienen bonus únicos y específicos descritos en su propio libro que sustituyen por completo al bonus inicial de dificultad ordinario.`
  },
  {
    ...
    title: "6. Tablas de Dificultad de Zonas y Comercio Oficial",
    category: "general",
...
• Reciclaje de Cartas redundantes: Visitar un Mercadillo te permite descartar permanentemente un máximo de 1 carta redundante de tu mano activa (exceptuando Especialidades iniciales, Características iniciales, Habilidades iniciales y Flechas Mágicas iniciales) para canjearla por 1 de Oro.`
  },
  {
    ...
    title: "7. Reglamento de Héroes: Héroe Principal y Héroe Secundario",
    category: "heroes",
...
• Derrota o Retirada Instantánea: Si tu Héroe Secundario es atacado por un Héroe enemigo, puedes elegir que ese Héroe sea derrotado instantáneamente en lugar de luchar (para conservar intactas las tropas). Al ser derrotado, elimínalo del juego. Puede ser reclutado de nuevo con otro uso de la ficha de Población.`
  },
  {
    ...
    title: "8. Estructura de las Rondas, Turno del Jugador y Acciones",
    category: "general",
...
• EXCEPCIÓN DE LA FACCIÓN NECRÓPOLIS: La facción Necrópolis ignora los efectos de Moral por completo. Las fuerzas de no-muertos no pueden ganar ni perder moral por ningún motivo del juego.`
  ...
  {
    id: "town_buildings_merged",
    title: "9. Ciudad: Desarrollo Urbano y Catálogo de Edificios",
    category: "town",
    content: `Cada facción tiene su propia Ciudad. El contenido de tu ciudad y el estado general de la facción están representados por el Tablero de Ciudad. Muestra los edificios construidos actualmente, los costes de recursos para futuros edificios, los ingresos de recursos y el estado de las fichas de acción de la ciudad.
• Construcción de Edificios: Se realiza mediante la ficha de Construcción (1 por turno). Todas las facciones pueden construir los siguientes edificios en sus Ciudades:
  - Alcaldía: Proporciona ingresos de recursos o una habilidad específica de la facción.
  - Ciudadela: Te permite Reforzar Unidades cuando usas la Ficha de Población. También protege tu Ciudad cuando es atacada.
  - Vivienda Tier I (Bronce): Permite Reclutar Unidades Bronce de la facción.
  - Vivienda Tier II (Plata): Permite Reclutar Unidades Plata de la facción.
  - Vivienda Tier III (Oro): Permite Reclutar Unidades Oro de la facción.
  - Cofradía de magos: Te entrega la ficha Libro de Hechizos indispensable para comprar Hechizos.
  - Edificios de Facción: Un edificio específico de una facción con un efecto único.

• Reclutamiento y Población de Criaturas:
  - Utiliza la ficha de Población de criaturas una vez por turno.
  - Solo se pueden reclutar tropas en viviendas que hayan sido erigidas en la ciudad. El coste viene indicado en la carta de la criatura.
  - Refuerzo de Tropas: Volteando la carta de unidad y abonando el coste de refuerzo, puedes transformar una unidad básica (Unas pocas) en su versión Élite (Manada).
...
El desarrollo de la metrópolis es fundamental para sustentar la economía de Erathia.

---

EDIFICIOS DE FACCIÓN Y SUS EFECTOS:
• Castillo - Hermandad de la Espada: Al comienzo de cada ronda de recursos gana Moral Positiva.
• Necrópolis - Manto de la oscuridad: Durante tu turno, elige: Descarta hasta 2 cartas de tu mano para robar otras 2 o Al comienzo del combate contra un héroe enemigo, descarta 1 carta al azar de su mano.
• Mazmorra - Portal de invocación: Al comienzo del turno, puedes robar 1 carta de unidad neutral de cada Tier que tengas en tu ciudad y pagar su coste para reclutarla.
• Murallas - Estanque místico: Al comienzo de cada ronda de recurso, lanza 1 dado de recursos y gana el resultado.
• Torre - Mercaderes de artefactos: Durante tu turno, elige: Paga 7 Oros para Buscar (2) Artefactos o Retira 1 carta de artefacto de tu mano para ganar 2 Oros.
• Fortaleza - Obelisco de sangre: Al comienzo de cada ronda de recursos o instantáneamente si tu ciudad es asediada, puedes buscar (4) en tu descarte.
• Inferno - Puerta del Castillo: Durante tu turno, elige: Paga 3 Oros para descartar 1 carta al azar de la mano de tu oponente o Si tu héroe está en una Ciudad o Asentamiento, muévelo a otra bajo tu control.
• Bastión - Salón de Valhalla: Una vez por ronda, una de las unidades gana +1 Ataque para un solo ataque.
• Conflujo - Universidad mágica: Una vez por ronda, en lugar de buscar en el mazo de Hechizos, elige una escuela de magia y descarta cartas del mazo hasta encontrar un hechizo de la escuela elegida, llévalo a tu mano.
• Cala - Cofradía de ladrones: Una vez durante tu turno, elige cualquier mazo del juego (incluido otro jugador), mira sus 2 cartas superiores y coloca una de ellas en su descarte y devuelve la otra a su mazo.`
  },
  {
    id: "tiles_navigation_merged",
    title: "10. Atlas de Erathia: Tipos de Losetas, Navegación y Subterráneo",
    category: "map",
...
• Losetas de Mar (Sea Map Tiles): Integradas en las expansiones marítimas de Cala. Presentan aguas de océano continuo. En estas losetas solo pueden detenerse héroes que hayan embarcado usando un Barco, lo que consume todos los puntos de movimiento de ese turno al embarcar.

La exploración del mapa avanzado introduce dos sistemas de movimiento bidimensionales e independientes:
...
• Cambiar de dimensión para reaparecer en la loseta de la capa opuesta consume el coste básico del hexágono destino de llegada más un recargo impositivo de 1 Punto de Movimiento (PM) de penalización extra de salto vertical.`
  ...
  {
    id: "map_locations_all",
    title: "11. Compendio Completo de Lugares del Mapa (Juego Base y Expansiones)",
    category: "map",
...
4. LUGARES ELEMENTALES (expansión Confluencia):
...
5. LUGARES MARÍTIMOS (expansión Cala - Savage Seas):
...
Se asimilan a las criptas terrestres. Contienen tesoros guardados por fantasmas y piratas no-muertos. Ofrecen abundantes Objetos de Valor y Dados de Tesoro.`
  },
  {
    ...
    title: "12. Tratado de las Cuatro Escuelas de Magia",
    category: "magic",
...
• Hechizos Clave:
  ...
  },
  {
    ...
    title: "13. Expansión Conflujo: Invocaciones, Daño Elemental, Pergaminos y Fichas de Tiempo",
    category: "magic",
...
• Límite: Máximo de 2 pergaminos en juego a la vez. Si obtienes un tercero, robas los nuevos hechizos y decides cuál de los tres pergaminos descartar.`
  },
  {
    ...
    title: "14. Expansión Cala: Navegación Marina, Torbellinos y Fichas Marítimas",
    category: "map",
...
• Santuario del Encantamiento Mágico (Visitable): Puedes abonar 3 de Oro para buscar (2) en el mazo de hechizos.`
  },
  {
    ...
    title: "15. Combate: Reglas, Obstáculos y Asedios",
    category: "combat",
...
I. EL CAMPO DE BATALLA (Cartas de Obstáculo)
Antes del despliegue convencional, los jugadores colocan las 7 losetas de obstáculos en el tablero o los muros y puerta en un asedio:
• Obstáculos (Obstáculos Ligeros): Bloquean el paso de las unidades terrestres, las unidades voladoras pueden atravesarlos, pero no permanecer sobre ellos.
• Puerta / Muros de Piedra (Obstáculos Pesados): Además del efecto anterior, penalizan los ataques a distancia, reduciendo su daño en 1.
...
• Muros y Puertas: Bloquean el curso terrestre convencional. Mientras permanezcan intactos, las tropas defensoras se encuentran resguardadas de ataques directos a corta distancia y obtienen protección extra pasiva (+1 defensa) frente a proyectiles lejanos de arqueros o Rangers.
• La Catapulta de Asedio: Ingenio indestructible del bando atacante que dispara de forma imperativa al abrirse cada ronda de combate completo. Para resolver el disparo, el atacante lanza el dado de combate estándar (cuyas caras son estrictamente -1, 0, +1):
  ...
  },
  {
    ...
    title: "16. Catálogo y Uso de Máquinas de Guerra Oficiales",
    category: "combat",
...
5. Cañón (Cannon): Carta permanente exclusiva de la facción de Cala (Cove). Se activa de forma automática al inicio de cada ronda de combate. Eliges una unidad o estructura enemiga y lanzas el dado de combate estándar: -1 inflige 1 herida / daño, 0 inflige 2 heridas / daños y +1 inflige 3 heridas / daños.`
  },
  {
    ...
    title: "17. Expansión de Campo de Batalla (Battlefield Expansion)",
    category: "modes",
...
• Asedios con Murallas y Puertas: Se colocan los obstáculos en posiciones fijas como indica el reglamento. Las tropas defensoras solo pueden cruzar la puerta a través de los dos hexágonos centrales impresos en la ficha, mientras que el atacante puede golpear la puerta desde cualquiera de los cuatro hexágonos adyacentes.`
  ...
  {
    id: "creature_banks_merged",
    title: "18. Bancos de Criaturas, Fichas de Apilamiento y Habilidades Potenciadas",
    category: "combat",
...
MECÁNICAS ADICIONALES DE LA EXPANSIÓN BATALLAS NAVALES (tablero naval y habilidades potenciadas):
La expansión Batallas Navales (Naval Battles) incorpora combates marítimos asimétricos, mecánicas de habilidades potenciadas y los peligrosos Bancos de Criaturas custodiados:
...
LISTADO ALTERNATIVO/AMPLIADO DE BANCOS DE CRIATURAS (expansión Batallas Navales, incluye defensores exactos):
...
• Utopía del Dragón: Defensores: 1 dragón negro, 1 dragón dorado, 1 dragón de cristal, 1 dragón hada. Recompensa: 40 Oro y busca (3) en el mazo de artefactos. Extra: Busca (5) en el mazo de artefactos o de hechizos por cada unidad apilada derrotada.`
  },
  {
    ...
    title: "19. Fichas de Estado, Palabras Clave de Combate e Invocación",
    category: "combat",
...
NOTA: Las Arenas Movedizas y la Ficha de Corrosión de la expansión Bastión siguen exactamente estas mismas reglas descritas arriba.`
  },
  {
    id: "heroes_specialties_abilities",
    title: "20. Héroes: Especialidades y Habilidades Iniciales",
    category: "combat",
...
Nota de Campaña: El héroe legendario Tarnum (Poder/Magia) está presente en múltiples facciones (Castillo, Mazmorra, Rampart, Fortress, Stronghold y Conflux) representando sus distintas encarnaciones históricas a través de las campañas oficiales de las expansiones ("Heroes Chronicles").`
  ...
  {
    id: "abilities_detailed",
    title: "21. Habilidades y Progresión del Héroe",
    category: "combat",
...
• Experto: El coste de compra de hechizos en esta Ciudad se reduce en 2 de Oro. Al comprar hechizos de tu Gremio de Magos, realiza Búsqueda(4) en lugar de Búsqueda(2).`
  },
  {
    ...
    title: "22. Habilidades Especiales de las Criaturas de Combate",
    category: "combat",
...
• No-Muerto (Undead): La unidad es inmune de forma pasiva a cualquier efecto que altere la moral (positiva o negativa). No puede recibir curaciones ni resurrecciones mágicas ordinarias que provengan de escuelas como la magia de agua o tierra pura.`
  ...
  {
    id: "units_catalog",
    title: "23. Catálogo Completo de Unidades por Facción: Reglas y Estadísticas",
    category: "combat",
...
A continuación se desglosa el catálogo completo indexado con todos los atributos oficiales, costes de reclutamiento y habilidades tácticas de las 10 facciones asimétricas y las invocaciones (excluyendo neutrales y banco de criaturas) de Heroes of Might and Magic III: El Juego de Mesa. 
...
• Alabarderos (Tier Bronce - Niv. 1)
  ...
  - Élite: Ataque 3, Defensa 1, Salud 2, Iniciativa 5. Tipo: Melé. Coste: 3 Oro. Habilidad: "Pasiva: Cuando esta unidad sea el objetivo de un ataque, puedes descartar una carta para ignorar el resultado del dado de ataque."
...
• Tiradores (Tier Bronce - Niv. 2)
  ...
  - Élite: Ataque 2, Defensa 0, Salud 2, Iniciativa 6. Tipo: a Distancia. Coste: 5 Oro. Habilidad: "Ataque: Si un objetivo no está adyacente, vuelve a atacarlo."
...
• Cruzados (Tier Plata - Niv. 4)
  ...
  - Élite: Ataque 4, Defensa 2, Salud 4, Iniciativa 6. Tipo: Melé. Coste: 10 Oro. Habilidad: "Ataque: Puedes volver a tirar los 0 en el dado de ataque de esta unidad."
...
• Fanáticos (Tier Plata - Niv. 5)
  ...
  - Élite: Ataque 4, Defensa 1, Salud 5, Iniciativa 7. Tipo: a Distancia. Coste: 12 Oro. Habilidad: "Pasiva: Ignora la penalización de combate contra unidades adyacentes."
...
• Campeones (Tier Oro - Niv. 6)
  ...
  - Élite: Ataque 6, Defensa 2, Salud 7, Iniciativa 9. Tipo: Melé. Coste: 20 Oro y 1 Objeto de valor. Habilidad: "Ataque: Si esta unidad termina su movimiento en un espacio diferente al inicial, puedes volver a tirar un dado de ataque."

• Arcángeles (Tier Oro - Niv. 7)
  - Básica: Ataque 6, Defensa 3, Salud 8, Iniciativa 12. Tipo: Voladora. Coste: 20 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Cuando se inicie un combate, roba 1 carta."
  - Élite: Ataque 7, Defensa 3, Salud 10, Iniciativa 18. Tipo: Voladora. Coste: 30 Oro y 2 Objetos de valor. Habilidad: "Pasiva: Una vez por combate. Cancela un ataque que fuese a reducir los Puntos de Salud de otra unidad a 0."
...
• Zombis (Tier Bronce - Niv. 2)
  - Básica: Ataque 2, Defensa 1, Salud 3, Iniciativa 3. Tipo: Melé. Coste: 3 Oro. Habilidad: "Pasiva: Si el atacante resuelve un +1 en el dado de ataque, obtén +1 Defensa."
  - Élite: Ataque 2, Defensa 1, Salud 3, Iniciativa 4. Tipo: Melé. Coste: 4 Oro. Habilidad: "Pasiva: Si el atacante resuelve un 0 o un +1 en el dado de ataque, obtén +1 Defensa."
...
• Vampiros (Tier Plata - Niv. 4)
  - Básica: Ataque 4, Defensa 1, Salud 4, Iniciativa 6. Tipo: Voladora. Coste: 8 Oro. Habilidad: "Ataque: Ignora el contraataque."
  - Élite: Ataque 5, Defensa 1, Salud 4, Iniciativa 9. Tipo: Voladora. Coste: 12 Oro. Habilidad: "Ataque: Ignora el contraataque. Después retira hasta 2 Heridas a esta unidad."

• Liches (Tier Plata - Niv. 5)
  - Básica: Ataque 3, Defensa 1, Salud 5, Iniciativa 6. Tipo: a Distancia. Coste: 8 Oro. Habilidades: Ninguna.
  - Élite: Ataque 4, Defensa 1, Salud 5, Iniciativa 7. Tipo: a Distancia. Coste: 14 Oro. Habilidad: "Ataque: Elige una unidad adyacente al objetivo y atácala. Para este ataque tu Ataque es 2."

• Caballeros del terror (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 2, Salud 7, Iniciativa 7. Tipo: Melé. Coste: 12 Oro. Habilidad: "Ataque: Al contraatacar después de este ataque, el enemigo lanza 2 dados de ataque y resuelve el resultado menor."
  - Élite: Ataque 6, Defensa 2, Salud 7, Iniciativa 9. Tipo: Melé. Coste: 20 Oro y 1 Objeto de valor. Habilidad: "Ataque: Si resuelves un 0 o un +1 en el dado de ataque, aumenta el valor total del ataque de esta unidad en un +1 adicional."
...
• Dragones fantasma (Tier Oro - Niv. 7)
  ...
  - Élite: Ataque 7, Defensa 3, Salud 9, Iniciativa 14. Tipo: Voladora. Coste: 32 Oro y 2 Objetos de valor. Habilidad: "Activación: Descarta la ficha Moral Positiva del enemigo. Ataque: Gana +1 Ataque."
...
• Trogloditas (Tier Bronce - Niv. 1)
  - Básica: Ataque 2, Defensa 1, Salud 2, Iniciativa 4. Tipo: Melé. Coste: 2 Oro. Habilidades: Ninguna.
  - Élite: Ataque 3, Defensa 1, Salud 2, Iniciativa 5. Tipo: Melé. Coste: 3 Oro. Habilidad: "Pasiva: Esta unidad ignora el efecto Parálisis."

• Arpías (Tier Bronce - Niv. 2)
  - Básica: Ataque 2, Defensa 0, Salud 3, Iniciativa 6. Tipo: Voladora. Coste: 3 Oro. Habilidad: "Ataque: Después del contraataque del enemigo, esta unidad puede volver al espacio desde el que se ha movido para atacar."
  - Élite: Ataque 3, Defensa 0, Salud 3, Iniciativa 9. Tipo: Voladora. Coste: 5 Oro. Habilidad: "Ataque: Ignora el contraataque. Esta unidad puede volver al espacio desde el que se ha movido para atacar."
...
• Ojos maléficos (Tier Bronce - Niv. 3)
  ...
  - Élite: Ataque 3, Defensa 1, Salud 3, Iniciativa 7. Tipo: a Distancia. Coste: 6 Oro. Habilidad: "Pasiva: Ignora la penalización de combate contra unidades adyacentes."
...
• Medusas (Tier Plata - Niv. 4)
  ...
  - Élite: Ataque 4, Defensa 1, Salud 4, Iniciativa 6. Tipo: a Distancia. Coste: 12 Oro. Habilidad: "Pasiva: Ignora la penalización de combate contra unidades adyacentes. Contraataque: El objetivo queda Parálizado."

• Minotauros (Tier Plata - Niv. 5)
  - Básica: Ataque 4, Defensa 2, Salud 4, Iniciativa 6. Tipo: Melé. Coste: 8 Oro. Habilidad: "Ataque: Si resuelves un -1 en el dado de ataque, roba una carta."
  - Élite: Ataque 5, Defensa 2, Salud 4, Iniciativa 8. Tipo: Melé. Coste: 14 Oro. Habilidad: "Ataque: Si resuelves un -1 en el dado de ataque, roba una carta."

• Mantícoras (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 1, Salud 6, Iniciativa 7. Tipo: Voladora. Coste: 10 Oro. Habilidades: Ninguna.
  - Élite: Ataque 5, Defensa 1, Salud 6, Iniciativa 11. Tipo: Voladora. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Ataque: Durante este ataque, ignora el valor de Defensa de la carta de la unidad objetivo."

• Mantícoras (Alternativa) (Tier Oro - Niv. 6)
  - Básica: Ataque 4, Defensa 1, Salud 7, Iniciativa 8. Tipo: Voladora. Coste: 12 Oro. Habilidad: "Ataque: Coloca 1 cubo de facción sobre el objetivo. Cuando se active, retira el cubo para infligir 1 Herida."
  - Élite: Ataque 4, Defensa 2, Salud 7, Iniciativa 11. Tipo: Voladora. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Después de cada ataque, coloca 1 cubo de facción sobre el objetivo. Cuando se active, retira el cubo para infligir 1 Herida."

• Dragones negros (Tier Oro - Niv. 7)
  - Básica: Ataque 6, Defensa 3, Salud 8, Iniciativa 11. Tipo: Voladora. Coste: 19 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Reduce el Daño de Hechizo recibido por esta unidad en 2 (hasta un mínimo de 0)."
  - Élite: Ataque 8, Defensa 3, Salud 8, Iniciativa 15. Tipo: Voladora. Coste: 33 Oro y 2 Objetos de valor. Habilidad: "Pasiva: Ignora cualquier efecto de Hechizo y Daño de especialidad."
...
• Enanos (Tier Bronce - Niv. 2)
  - Básica: Ataque 2, Defensa 1, Salud 3, Iniciativa 3. Tipo: Melé. Coste: 3 Oro. Habilidad: "Pasiva: Si esta unidad es objetivo de cualquier carta de hechizo o especialidad, lanza 1 dado de ataque. Si sacas un +1, ignora el efecto de la carta."
  - Élite: Ataque 3, Defensa 1, Salud 3, Iniciativa 5. Tipo: Melé. Coste: 4 Oro. Habilidad: "Pasiva: Si esta unidad es objetivo de cualquier carta de hechizo o especialidad, lanza 1 dado de ataque. Si sacas un +1, ignora el efecto de la carta."

• Elfos (Tier Bronce - Niv. 3)
  - Básica: Ataque 2, Defensa 1, Salud 3, Iniciativa 6. Tipo: a Distancia. Coste: 4 Oro. Habilidades: Ninguna.
  - Élite: Ataque 3, Defensa 1, Salud 3, Iniciativa 7. Tipo: a Distancia. Coste: 7 Oro. Habilidad: "Ataque: Si una unidad objetivo no está adyacente, vuélvela a atacar si sacas un -1 o un 0."

• Pegasos (Tier Plata - Niv. 4)
  - Básica: Ataque 3, Defensa 0, Salud 5, Iniciativa 8. Tipo: Voladora. Coste: 6 Oro. Habilidades: Ninguna.
  - Élite: Ataque 4, Defensa 0, Salud 6, Iniciativa 12. Tipo: Voladora. Coste: 10 Oro. Habilidad: "Pasiva: El Poder de todos los hechizos enemigos se reduce en 1 (hasta un mínimo de 0)."

• Dendroides (Tier Plata - Niv. 5)
  - Básica: Ataque 4, Defensa 2, Salud 5, Iniciativa 3. Tipo: Melé. Coste: 8 Oro. Habilidades: Ninguna.
  - Élite: Ataque 4, Defensa 2, Salud 6, Iniciativa 4. Tipo: Melé. Coste: 15 Oro. Habilidad: "Pasiva: Las unidades enemigas que empiecen su activación adyacentes a esta unidad no pueden moverse."

• Unicornios (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 1, Salud 8, Iniciativa 7. Tipo: Melé. Coste: 11 Oro. Habilidad: "Pasiva: Reduce el Daño de Hechizos sufridos por esta unidad en 1 (hasta un mínimo de 0)."
  - Élite: Ataque 6, Defensa 1, Salud 8, Iniciativa 9. Tipo: Melé. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Reduce el Daño de Hechizos sufridos por esta unidad y unidades adyacentes aliadas en 1 (hasta un mínimo de 0)."

• Dragones dorados (Tier Oro - Niv. 7)
  - Básica: Ataque 5, Defensa 3, Salud 9, Iniciativa 10. Tipo: Voladora. Coste: 22 Oro y 1 Objeto de valor. Habilidad: "Ataque: Ataca a 2 espacios en fila. El primer ataque se resuelve de forma normal y el segundo con 2 Ataque."
  - Élite: Ataque 6, Defensa 3, Salud 10, Iniciativa 16. Tipo: Voladora. Coste: 30 Oro y 2 Objetos de valor. Habilidad: "Ataque: Ataca a 2 espacios en fila. El primer ataque se resuelve normalmente y el segundo tiene 3 Ataque."
...
• Magos (Tier Plata - Niv. 4)
  - Básica: Ataque 3, Defensa 0, Salud 4, Iniciativa 5. Tipo: a Distancia. Coste: 6 Oro. Habilidad: "Ataque: Ignora penalizaciones de combate."
  - Élite: Ataque 4, Defensa 1, Salud 4, Iniciativa 6. Tipo: a Distancia. Coste: 11 Oro. Habilidad: "Ataque: Ignora penalizaciones de combate. Activación: Añade +1 Poder al primer hechizo que lances esta ronda."
...
• Genios (Tier Plata - Niv. 5)
  ...
  - Élite: Ataque 4, Defensa 1, Salud 6, Iniciativa 8. Tipo: Voladora. Coste: 12 Oro. Habilidad: "Ataque: Descarta hasta 3 cartas de tu mazo y devuelve a tu mano un Hechizo descartado de esta forma."

• Nagas (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 2, Salud 7, Iniciativa 6. Tipo: Melé. Coste: 13 Oro. Habilidad: "Ataque: Ignora contraataques."
  - Élite: Ataque 6, Defensa 2, Salud 7, Iniciativa 8. Tipo: Melé. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Ataque: Ignora contraataques."
...
• Familiares (Tier Bronce - Niv. 1)
  ...
  - Élite: Ataque 3, Defensa 1, Salud 2, Iniciativa 7. Tipo: Melé. Coste: 3 Oro. Habilidad: "Pasiva: Cuando un enemigo lanza un Hechizo de su mano, debe descartar 1 carta de la mano."

• Magogs (Tier Bronce - Niv. 2)
  - Básica: Ataque 2, Defensa 0, Salud 2, Iniciativa 4. Tipo: a Distancia. Coste: 3 Oro. Habilidades: Ninguna.
  - Élite: Ataque 2, Defensa 0, Salud 3, Iniciativa 6. Tipo: a Distancia. Coste: 5 Oro. Habilidad: "Ataque: Cuando los magogs atacan a un objetivo que no está adyacente a ellos, hacen 1 Herida a una unidad adyacente al objetivo."

• Cerberos (Tier Bronce - Niv. 3)
  - Básica: Ataque 3, Defensa 0, Salud 4, Iniciativa 7. Tipo: Melé. Coste: 4 Oro. Habilidades: Ninguna.
  - Élite: Ataque 3, Defensa 1, Salud 5, Iniciativa 8. Tipo: Melé. Coste: 7 Oro. Habilidad: "Ataque: Ignora contraataques. Además, hace 1 Herida a otra unidad enemiga adyacente a los cerberos."
...
• Efrits (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 1, Salud 7, Iniciativa 9. Tipo: Voladora. Coste: 12 Oro. Habilidad: "Pasiva: Ignora el Daño del hechizo Flecha mágica."
  - Élite: Ataque 6, Defensa 1, Salud 7, Iniciativa 13. Tipo: Voladora. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Ignora cualquier Daño de la Flecha mágica y hechizos de la escuela de fuego."

• Archidiablos (Tier Oro - Niv. 7)
  - Básica: Ataque 6, Defensa 3, Salud 8, Iniciativa 11. Tipo: Voladora. Coste: 22 Oro y 1 Objeto de valor. Habilidad: "Ataque: Ignora contraataques."
  - Élite: Ataque 7, Defensa 3, Salud 9, Iniciativa 15. Tipo: Voladora. Coste: 30 Oro y 2 Objetos de valor. Habilidad: "Ataque: Ignora contraataques. Pasiva: Al moverse, los archidiablos se pueden mover a cualquier espacio vacío."
...
• Incursores lupinos (Tier Bronce - Niv. 2)
  ...
  - Élite: Ataque 2, Defensa 0, Salud 4, Iniciativa 8. Tipo: Melé. Coste: 5 Oro. Habilidad: "Ataque: Ataca este objetivo otra vez. El segundo ataque se produce después de que el objetivo contraataque (si es posible)."
...
• Aves de trueno (Tier Plata - Niv. 5)
  ...
  - Élite: Ataque 4, Defensa 1, Salud 6, Iniciativa 11. Tipo: Voladora. Coste: 14 Oro. Habilidad: "Pasiva: Justo después del ataque de esta unidad y antes de un contraataque, tira 1 dado de ataque; con un 0 o +1, inflige 1 Herida al objetivo."
...
• Behemoths (Tier Oro - Niv. 7)
  - Básica: Ataque 6, Defensa 2, Salud 9, Iniciativa 6. Tipo: Melé. Coste: 19 Oro y 1 Objeto de valor. Habilidad: "Ataque: Disminuye la Defensa del objetivo en 1 (hasta un mínimo de 0)."
  - Élite: Ataque 7, Defensa 2, Salud 10, Iniciativa 9. Tipo: Melé. Coste: 29 Oro y 2 Objetos de valor. Habilidad: "Ataque: Disminuye la Defensa del objetivo en 2 (hasta un mínimo de 0). Después del ataque, pon 1 ficha de corrosión en el objetivo."
...
• Libélulas (Tier Bronce - Niv. 3)
  - Básica: Ataque 3, Defensa 0, Salud 3, Iniciativa 8. Tipo: Voladora. Coste: 4 Oro. Habilidad: "Ataque: Retira todos los efectos Continuos que el enemigo ha jugado sobre el objetivo."
  - Élite: Ataque 3, Defensa 1, Salud 3, Iniciativa 12. Tipo: Voladora. Coste: 7 Oro. Habilidad: "Ataque: Retira todos los efectos Continuos que el enemigo ha jugado sobre el objetivo. Si el objetivo contraataca, sufre -1 Ataque."

• Basiliscos (Tier Plata - Niv. 4)
  - Básica: Ataque 4, Defensa 1, Salud 4, Iniciativa 5. Tipo: Melé. Coste: 6 Oro. Habilidad: "Ataque: Con un resultado -1 en el dado de ataque la unidad atacada recibe una ficha Parálisis."
  - Élite: Ataque 4, Defensa 1, Salud 5, Iniciativa 7. Tipo: Melé. Coste: 9 Oro. Habilidad: "Ataque: Con un resultado -1 en el dado de ataque la unidad atacada recibe una ficha Parálisis."

• Gorgonas (Tier Plata - Niv. 5)
  - Básica: Ataque 4, Defensa 2, Salud 5, Iniciativa 5. Tipo: Melé. Coste: 9 Oro. Habilidades: Ninguna.
  - Élite: Ataque 5, Defensa 2, Salud 5, Iniciativa 6. Tipo: Melé. Coste: 14 Oro. Habilidad: "Ataque: Después del ataque, lanza 2 dados de ataque; si sacas un doble 0, reduce los Puntos de Salud de la unidad objetivo a 0."

• Wyverns (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 1, Salud 8, Iniciativa 7. Tipo: Voladora. Coste: 12 Oro. Habilidad: "Ataque: Coloca 1 cubo de facción sobre el objetivo. Al comienzo de su activación retíralo para infligirle 1 Herida."
  - Élite: Ataque 6, Defensa 1, Salud 8, Iniciativa 11. Tipo: Voladora. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Ataque: Coloca 2 cubos de facción sobre el objetivo. Al comienzo de cada activación, retira 1 para infligirle 1 Herida."

• Hidras (Tier Oro - Niv. 7)
  - Básica: Ataque 6, Defensa 3, Salud 8, Iniciativa 5. Tipo: Melé. Coste: 20 Oro y 1 Objeto de valor. Habilidad: "Ataque: Ignora el contraataque."
  - Élite: Ataque 7, Defensa 3, Salud 10, Iniciativa 7. Tipo: Melé. Coste: 28 Oro y 2 Objetos de valor. Habilidad: "Ataque: Ignora el contraataque. Esta unidad ataca a hasta 2 unidades enemigas adyacentes."
...
• Hadas (Tier Bronce - Niv. 1)
  ...
  - Élite: Ataque 2, Defensa 0, Salud 4, Iniciativa 9. Tipo: Melé. Coste: 4 Oro. Habilidad: "Ataque: Ignora los contraataques."
...
• Elementales de la tormenta (Tier Bronce - Niv. 2)
  ...
  - Élite: Ataque 2, Defensa 0, Salud 5, Iniciativa 8. Tipo: a Distancia. Coste: 5 Oro. Habilidad: "Ataque: Añade +1 Potencia al primer hechizo de magia de aire que lances durante esta activación."
...
• Elementales mágicos (Tier Oro - Niv. 6)
  - Básica: Ataque 4, Defensa 2, Salud 7, Iniciativa 7. Tipo: Melé. Coste: 13 Oro. Habilidad: "Ataque: Ignora los contraataques. Ataca a todas las unidades adyacentes."
  - Élite: Ataque 5, Defensa 2, Salud 7, Iniciativa 9. Tipo: Melé. Coste: 19 Oro y 1 Objeto de valor. Habilidad: "Ataque: Ignora los contraataques. Ataca todas las unidades enemigas adyacentes. Pasiva: Ignora cualquier efecto de Hechizo y Daño de especialidad."

• Fénix (Tier Oro - Niv. 7)
  - Básica: Ataque 6, Defensa 2, Salud 7, Iniciativa 12. Tipo: Voladora. Coste: 21 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Una vez por combate. Cuando los PS de esta unidad se reduzcan a 0, ponlos en 1. Pasiva: Inmunes a los Hechizos de magia de fuego."
  - Élite: Ataque 7, Defensa 2, Salud 8, Iniciativa 18. Tipo: Voladora. Coste: 29 Oro y 2 Objetos de valor. Habilidad: "Ataque: Ataca 2 espacios en una línea. El primer ataque se resuelve normalmente y el segundo tiene 2 Ataque. Pasiva: Inmunes a los Hechizos de magia de fuego."
...
• Oceánidos (Tier Bronce - Niv. 1)
  ...
  - Élite: Ataque 3, Defensa 0, Salud 3, Iniciativa 8. Tipo: Voladora. Coste: 3 Oro. Habilidad: "Pasiva: Ignora todos los efectos y Daño de un Hechizo de magia de agua."

• Marineros (Tier Bronce - Niv. 2)
  - Básica: Ataque 2, Defensa 1, Salud 3, Iniciativa 5. Tipo: Melé. Coste: 3 Oro. Habilidades: Ninguna.
  - Élite: Ataque 2, Defensa 1, Salud 5, Iniciativa 6. Tipo: Melé. Coste: 5 Oro. Habilidad: "Pasiva: Una vez por combate, cuando esta unidad retira una unidad del combate, gana 2 Oros."

• Lobos de mar (Tier Bronce - Niv. 3)
  - Básica: Ataque 2, Defensa 0, Salud 4, Iniciativa 6. Tipo: a Distancia. Coste: 4 Oro. Habilidad: "Pasiva: Ignora la penalización de combate contra unidades adyacentes."
  - Élite: Ataque 3, Defensa 0, Salud 5, Iniciativa 8. Tipo: a Distancia. Coste: 6 Oro. Habilidad: "Ataque: Ignora los contraataques. Pasiva: Ignora la penalización de combate contra unidades adyacentes."

• Ayssids (Tier Plata - Niv. 4)
  - Básica: Ataque 3, Defensa 1, Salud 5, Iniciativa 9. Tipo: Voladora. Coste: 6 Oro. Habilidades: Ninguna.
  - Élite: Ataque 3, Defensa 1, Salud 6, Iniciativa 11. Tipo: Voladora. Coste: 10 Oro. Habilidad: "Ataque: Si los Puntos de salud del objetivo se reducen a 0, después de resolver el Contraataque (si corresponde), los Ayssids pueden atacar a otra unidad adyacente."
...
• Hechiceras (Tier Plata - Niv. 5)
  ...
  - Élite: Ataque 4, Defensa 1, Salud 6, Iniciativa 7. Tipo: a Distancia. Coste: 13 Oro. Habilidad: "Ataque: Después del ataque, coloca una ficha de Debilidad <<-1>> sobre el objetivo durante 2 rondas de combate."

• Nix (Tier Oro - Niv. 6)
  - Básica: Ataque 5, Defensa 2, Salud 7, Iniciativa 6. Tipo: Melé. Coste: 12 Oro. Habilidades: Ninguna.
  - Élite: Ataque 6, Defensa 2, Salud 8, Iniciativa 7. Tipo: Melé. Coste: 20 Oro y 1 Objeto de valor. Habilidad: "Pasiva: Esta unidad no puede recibir más de 4 Heridas de un solo ataque."

• Háspidos (Tier Oro - Niv. 7)
  - Básica: Ataque 5, Defensa 3, Salud 8, Iniciativa 9. Tipo: Melé. Coste: 18 Oro y 1 Objeto de valor. Habilidad: "Ataque: +2 Ataque si, durante este combate, esta unidad se giró del lado de manada al lado de unos pocos."
  - Élite: Ataque 7, Defensa 3, Salud 8, Iniciativa 12. Tipo: Melé. Coste: 30 Oro y 2 Objetos de valor. Habilidad: "Ataque: Coloca 2 cubos de facción sobre el objetivo. Al comienzo de cada una de sus activaciones, retira 1 de ellos para infligir 1 Herida."

---

### 11. INVOCACIONES (Summons)
• Elementales de aire (Niv. 2)
  - Básica: Ataque 2, Defensa 0, Salud 4, Iniciativa 8. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de aire. Esta unidad inflige daño elemental."
  - Élite: Ataque 3, Defensa 0, Salud 4, Iniciativa 8. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de aire. Esta unidad inflige daño elemental."

• Elementales de agua (Niv. 2)
  - Básica: Ataque 2, Defensa 0, Salud 5, Iniciativa 6. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de agua. Esta unidad inflige daño elemental."
  - Élite: Ataque 3, Defensa 0, Salud 5, Iniciativa 6. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de agua. Esta unidad inflige daño elemental."

• Elementales de fuego (Niv. 3)
  - Básica: Ataque 2, Defensa 1, Salud 4, Iniciativa 5. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de fuego. Esta unidad inflige daño elemental."
  - Élite: Ataque 3, Defensa 1, Salud 4, Iniciativa 5. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de fuego. Esta unidad inflige daño elemental."

• Elementales de tierra (Niv. 3)
  - Básica: Ataque 2, Defensa 2, Salud 2, Iniciativa 5. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de tierra. Esta unidad inflige daño elemental."
  - Élite: Ataque 3, Defensa 2, Salud 2, Iniciativa 5. Tipo: Melé. Habilidad: "Pasiva: Inmunes a la Flecha mágica y a los Hechizos de magia de tierra. Esta unidad inflige daño elemental."`
  },
  {
    id: "scenario_modes_and_end_conditions",
    title: "24. Modos de Juego (Enfrentamiento, Campaña, Alianza, Cooperativo) y Fin de Escenario",
    category: "modes",
...
• En escenarios con tres o más jugadores, recoger un Cubo de Facción de cada jugador enemigo te hace ganar inmediatamente la partida. Otras reglas específicas del Escenario también pueden modificar el resultado de la recogida de Cubos de Facción.`
  },
  {
    ...
    title: "25. Reglamento Detallado de la Inteligencia Artificial (IA)",
    category: "modes",
...
• Conjuros de Bufos de Una Ronda (p. ej. Fire Shield): Verifica la unidad de la IA a beneficiar. Si más de la mitad de las tropas del mismo Tier o superior ya se han activado en la ronda actual, la IA pospone el lanzamiento del escudo hasta el inicio de la siguiente ronda táctica, acumulándolo.`
  },
  {
    ...
    title: "26. Reglamento Oficial del Modo Torneo (Libro de Torneo)",
    category: "modes",
    content: `Contenido verificado directamente contra el Libro de Torneo oficial (Tournament Book, v1.0 ESP). El Modo Torneo son partidas 1 contra 1 con reglas propias de construcción de mapa, puntuación y ajustes de equilibrio.
...
Pasos oficiales: 1) Título y descripción. 2) Nº de jugadores (2 en el básico; expansiones permiten más). 3) Duración en rondas (máx. recomendado 16, si necesitas más divide en varios escenarios tipo campaña). 4) Diseño del mapa (recomendado por jugador: 1 loseta inicial, 2 cercanas, 2 lejanas; usa las reglas de construcción de mapa de torneo o dibuja tu propio mapa; asegúrate de que el acceso a tipos de loseta sea equivalente entre jugadores). 5) Recursos iniciales (por defecto 15 oro/3 materiales/1 valioso). 6) Ingresos iniciales (por defecto «10» oro/«0» materiales/«0» valiosos). 7) Edificios iniciales. 8) Unidades iniciales (por defecto 3 "unas pocas" de bronce). 9) Bonificadores iniciales adicionales (normalmente reservado a campañas). 10) Reglas del escenario (qué hacen los lugares especiales como obeliscos o la utopía del dragón). 11) Condición(es) de victoria. 12) Qué ocurre al llegar al límite de rondas. 13) Eventos contrarreloj (qué deben hacer los jugadores al llegar a ciertas rondas).`
  ...
  {
    id: "rule_variants",
    title: "27. Variantes de Reglas Oficiales (Chaos, Draft, Split Decks y Gold Pool)",
    category: "modes",
...
• Variantes de Sistema: El dado de combate rojo no influye en las heridas (solo activa habilidades); se roba un anuncio astrológico al inicio de las rondas de recursos; eliminación completa de anuncios astrológicos en la partida; los cubos negros de enclaves visitados se remueven en las Rondas 4, 8 y 12.`
  },
  {
    ...
    title: "28. Opciones Avanzadas de la Comunidad (No Oficiales)",
    category: "modes",
...
Para partidas con límite de tiempo, cada jugador dispone de un pool de minutos por turno acordado antes de la partida. El exceso de tiempo consumido puede penalizar el siguiente turno restando 1 Ficha de Movimiento, si así lo acuerdan los jugadores.`
  },
  {
    ...
    title: "29. FAQ Oficial del Diseñador (Respuesta Astrológica / Designer's Commentary)",
    category: "faq",
...
• Por norma general se lanza 1 hechizo por ronda de combate, salvo que un efecto (p. ej. cartas de conocimiento en su versión Experto) amplíe ese límite.`
  },
  {
    ...
    title: "30. FAQs: Criaturas y Unidades",
    category: "faq",
...
R: Las unidades derrotadas van a tu pila de bajas personal. Durante tu Fase de Planificación, puedes realizar la acción de Reclutar en tu ciudad, pagando el coste total de Oro de las unidades disponibles en tus viviendas construidas para devolverlas a tu ejército activo.`
  },
  {
    ...
    title: "31. FAQs: Mecánicas de Juego y Exploración",
    category: "faq",
...
R: No. El reglamento limita estrictamente el desarrollo urbano a exactamente una estructura construida por ronda durante tu Fase de Planificación, pagando los costes correspondientes en Oro, Madera, Mineral o Valiosos en tu track de recursos de ciudad.`
  },
  {
    ...
    title: "32. FAQs: Habilidades y Especialidades",
    category: "faq",
...
R: No. La habilidad de Artillería afecta de forma muy selectiva: su nivel básico inflige 1 herida directa a la unidad enemiga de menor iniciativa en el tablero, y su nivel experto potencia única y exclusivamente los disparos de la Balista (permitiendo resolver su disparo 3 veces consecutivas al mismo objetivo). No otorga ninguna bonificación a la Catapulta ni al Carro de Municiones.`
  ...
  {
    id: "faq_game_modes",
    title: "33. FAQs: Modos de Juego y Alianzas",
    category: "faq",
...
- El jugador eliminado no queda inactivo en la mesa de juego: asume el control directo de las Unidades Neutrales de la Inteligencia Artificial en todos los combates que libren los jugadores supervivientes, intentando derrotarlos en el tablero táctico.`
  ...
  {
    id: "faq_spells_magic",
    title: "34. FAQs: Hechizos y Magia",
    category: "faq",
...
R: Bendecir obliga a tu criatura a ignorar la tirada física del dado, aplicando automáticamente el daño máximo listado en su ficha. Dado que no se realiza una tirada física, no se genera ningún resultado del dardo. Cualquier habilidad de una unidad que dependa de caras específicas del dado de ataque (como las bonificaciones al salir un +1 o maldiciones al salir un -1) no puede activarse.`
  },
  {
    ...
    title: "35. FAQs: Artefactos, Pergaminos y Grial",
    category: "faq",
...
4. Si acertaste, añade la carta del Grial directamente a tu mano. Si fallas, pierdes el PM empleado. Llevar el Grial de vuelta a tu ciudad capital te permite erigir la estructura legendaria del Grial, otorgando +20 de Oro en cada Fase de Recursos y un poder mítico único de facción.`
  ...
  {
    id: "scenario_campaign_compendium",
    title: "36. Compendio de Escenarios y Campañas: Libros de Misiones Oficiales",
    category: "modes",
...
2. MAZMORRA - Su campaña en solitario "La Sangre del Dragón" (héroe: Mutare o Alamar; enemigo: Castillo) se encuentra en el Libro de Misiones de Metas Ampliadas (Stretch Goals), junto con las campañas de Necrópolis y Torre.
  • Misión de Campaña I: "Limpieza de Aspirantes" (11 rondas) — derrotar a los 2 héroes enemigos (Caomham y Preuet)
  • Misión de Campaña II: "Sangre del Padre Dragón" (11 rondas) — derrotar al ejército en la utopía del dragón (derrotar al héroe rival es opcional).
  • Misión de Campaña III: "Sed de Sangre" (10 rondas) — sobrevivir a los ataques de 4 héroes enemigos consecutivos (3 señores + Ordwald).
...
3. NECRÓPOLIS - Campaña "El Ascenso del Nigromante" (héroe: Sandro o Tamika; enemigos variados), en el Libro de Misiones de Metas Ampliadas.
  • Misión de Campaña I: "Objetivo" (8 rondas) — derrotar a los 2 héroes enemigos (Shiva y Jeddite).
  • Misión de Campaña II: "Maestro" (10 rondas) — derrotar a los 2 héroes enemigos (Ivor y Ethric).
  • Misión de Campaña III: "Duque Alarice" (11 rondas) — derrotar a todos los héroes enemigos (Thorgrim, Melodia, duque Alarice) y ganar el combate final en la utopía del dragón.

--- FACCIONES DE EXPANSIONES ---

4. TORRE - Su campaña en solitario "El Matadragones" (héroe: Dracon o Solmyr) está en el Libro de Misiones de Metas Ampliadas.
  • Misión de Campaña I: "Dragones de Cristal" (9 rondas) — visitar un obelisco y ganar el combate que aparece ahí.
  • Misión de Campaña II: "Dragones Herrumbrosos" (11 rondas, requiere expansión Fortaleza) — capturar todas las minas y el estanque de gemas, derrotando a los ejércitos que las defienden.
  • Misión de Campaña III: "Dragones Hada" (13 rondas, requiere expansión Murallas) — capturar todos los asentamientos del mapa y ganar el combate final en la Caja de Pandora.
  • Misión de Campaña IV: "Dragones Azures" (11 rondas) — visitar los 3 obeliscos (cada uno con un combate distinto: cristal, negros, azures) y después derrotar al ejército final en la utopía del dragón. Tras controlar el primer obelisco, la dificultad de todos los combates del mapa sube +1. 
  
5. MURALLAS - Libro de Misiones de Murallas. Campaña "La Venganza se Sirve Fría" (héroe: Gelu/Gem; enemigo: Necrópolis):
...
6. FORTALEZA - Libro de Misiones de Fortaleza. Campaña "Jugando con Fuego" (héroe: Adrienne o Wystan; enemigo: Necrópolis):
...
Modo Solitario — "Isla de Fuego" (1 jugador, 16 rondas): cada loseta descubierta recibe un Banco de Criaturas distinto (Tesoro de los Diablillos, Conservatorio de Grifos, Banco de Nagas, Pirámide, Utopía del Dragón del banco de criaturas). Victoria: ganar un combate en todos los bancos de criaturas del mapa.`
  },
  {
    ...
    title: "41. Expansión Murallas: Nuevos Elementos y Modo Alianza Avanzado",
    category: "modes",
...
• Mercadillo (actualizado en esta expansión) — Categoría Revisitable. Ahora permite además comprar una máquina de guerra (con el recargo de +3 de oro descrito arriba), aparte de sus funciones habituales de intercambiar recursos o retirar una carta.`
  },
  {
    ...
    title: "42. Expansión Murallas: Escenarios Independientes (Alianza y Enfrentamiento)",
    category: "modes",
...
• Evento contrarreloj: en las rondas 2, 4, 6, 8 y 10 se retiran los cubos negros de todos los molinos y molinos de agua del mapa.`
  },
  {
    ...
    title: "43. Expansión Murallas: Campaña en Solitario (La Venganza se Sirve Fría)",
    category: "modes",
...
Regla común a los 3 escenarios: los héroes enemigos se mueven después del jugador; si un enemigo está en una zona bloqueada, el jugador puede entrar igualmente en ella; tras derrotar al ejército de un héroe enemigo se ganan 2 objetos de valor; la primera vez que el héroe entra en una zona con obelisco se activa un evento de historia único de esa partida.`
  },
  {
    ...
    title: "44. Escenarios Oficiales del Libro de Torneo (1 contra 1)",
    category: "modes",
...
Mapa: 2 losetas iniciales (I) + 2 cercanas con obelisco (una por jugador) + 2 cercanas sin obelisco + 2 centrales (VI-VII) con las zonas del grial y la utopía del dragón + 6 lejanas (II-III). Mismos recursos/ingresos/edificios/unidades iniciales. Regla especial: al visitar un obelisco, elige entre (a) lanzar 1 dado de recursos y 1 de tesoro y quedarte con el resultado de uno de los dos, o (b) buscar(2) en el mazo de artefactos. No se puede visitar la zona del grial hasta haber visitado 2 obeliscos diferentes, o que otro héroe ya haya cogido la ficha una vez; conseguirla cuesta 2 PM. Un jugador gana 3 PV adicionales al final del escenario si controla la utopía del dragón Y tiene la ficha de grial. Condición de victoria: al final de cualquier ronda en que alguien controle la utopía del dragón Y tenga la ficha de grial, se juega 1 ronda más y termina la partida. Si esto no ocurre antes del final de la ronda 14, la partida acaba igualmente y se cuentan los PV.`
  },
  {
    ...
    title: "45. Expansión Contenido Adicional: Losetas Subterráneas, Puertas, Barcos, Ciudad Aleatoria y Campo de Fuerza",
    category: "map",
...
• Revelación y Daño: El jugador puede mirar el reverso de sus propias minas sembradas en cualquier momento. Cuando una unidad enemiga entra en una casilla con ficha de mina, se revela: si está vacía, no sufre penalización y sigue moviéndose; si muestra el símbolo de daño, la unidad sufre automáticamente 2 heridas directas y, si sobrevive, finaliza su activación en dicha casilla. Dos fichas de mina de jugadores rivales pueden coincidir en el mismo espacio táctico.`
  },
  {
    ...
    title: "46. Batallas Navales y Navegación (Sea & Ships)",
    category: "map",
...
• Boyas y Faros: Visitar boyas en el mapa de aventura otorga +1 PM gratis de movimiento marítimo temporal, y los Faros incrementan de forma pasiva la velocidad de navegación del jugador que los controle.`
  },
  {
    ...
    title: "47. Expansión del Subterráneo (Underworld)",
    category: "map",
