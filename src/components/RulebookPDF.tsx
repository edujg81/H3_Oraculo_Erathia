      ...
      <div id="print-area" className="space-y-8 text-slate-300 font-sans leading-relaxed text-sm">
          ...
          <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800 space-y-2 mt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs leading-relaxed">
              ...
              <div className="border border-slate-900 p-2 rounded bg-slate-950/40">
                ...
                Aptitudes de progresión ordinarias que se eligen mediante draft (robar 2 cartas, retener 1 y descartar la otra) al alcanzar los niveles plata II, III, V y VII.
              </div>
              <div className="border border-slate-900 p-2 rounded bg-slate-950/40">
        ...
        <section className="space-y-4 page-break">
          ...
          <p className="text-[10px] uppercase font-mono text-slate-400 mt-1">
            Las Habilidades representan la progresión del Héroe. Al subir de nivel plata (II, III, V y VII), el Héroe draftea de un mazo común. Poseen un efecto <strong>Básico</strong> y un efecto <strong>Experto</strong>.
          </p>
          <div className="overflow-x-auto">
